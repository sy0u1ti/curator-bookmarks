...
import { Button, cx, Icon, ThemeProvider } from '../ui'
...
const BACKGROUND_MASK_ENABLED_CLASS = 'opacity-100 [-webkit-backdrop-filter:blur(var(--background-mask-blur))_saturate(0.92)] [backdrop-filter:blur(var(--background-mask-blur))_saturate(0.92)]'
const BACKGROUND_MASK_STYLE_CLASS_BY_STYLE = {
  dark: 'bg-[rgba(0,0,0,0.34)]',
  frosted: 'bg-[rgba(18,18,20,0.2)]',
  light: 'bg-[rgba(255,255,255,0.14)]',
  noise: 'bg-[rgba(0,0,0,0.24)] before:opacity-20 before:[background-image:radial-gradient(rgba(255,255,255,0.2)_0.65px,transparent_0.9px),radial-gradient(rgba(0,0,0,0.28)_0.7px,transparent_1px)] before:[background-position:0_0,12px_14px] before:[background-size:4px_4px,5px_5px]'
} as const
