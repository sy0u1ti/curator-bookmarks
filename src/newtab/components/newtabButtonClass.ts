...
const NEWTAB_BUTTON_BASE_CLASS = 'newtab-button inline-flex min-h-[34px] items-center justify-center gap-2 whitespace-nowrap rounded-ds-sm border px-[18px] text-center text-sm font-bold leading-none outline-offset-[3px] cursor-pointer transition-colors duration-ds-standard ease-ds-standard focus-visible:outline-2 focus-visible:outline-ds-focus active:scale-[var(--ds-press-scale)] disabled:cursor-default disabled:opacity-60'
