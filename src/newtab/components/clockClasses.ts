...
const CLOCK_BASE_CLASS = 'newtab-clock grid w-fit max-w-[min(100%,1229px)] min-h-[calc(38px*var(--clock-scale))] auto-cols-max grid-flow-col items-center justify-center gap-[calc(10px*var(--clock-scale))] rounded-[calc(12px*var(--clock-scale))] border border-[rgba(245,245,247,0.11)] bg-[rgba(8,8,9,var(--clock-surface-alpha))] px-[calc(11px*var(--clock-scale))] py-[calc(7px*var(--clock-scale))] text-center text-[var(--ui-text-primary)] shadow-[inset_0_1px_0_rgba(255,255,255,0.045)] [filter:drop-shadow(0_14px_32px_rgba(0,0,0,0.14))] select-none [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)] [--clock-surface-alpha:0.18]'
const CLOCK_COMPACT_CLASS = 'min-h-[calc(24px*var(--clock-scale))] gap-[calc(8px*var(--clock-scale))] border-transparent bg-transparent p-0 shadow-none [filter:none] [-webkit-backdrop-filter:none] [backdrop-filter:none] [--clock-surface-alpha:0]'
