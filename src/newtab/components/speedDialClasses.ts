...
const SPEED_DIAL_CARD_BASE_CLASS = `curator-motion-card newtab-speed-dial-card [--bookmark-card-rgb:245_245_247] [--icon-shell-size:34px] [--icon-title-lines:1] grid min-h-[58px] min-w-0 grid-cols-[34px_minmax(0,1fr)] items-center gap-[9px] rounded-[var(--ui-radius-control)] border border-[var(--ui-divider)] bg-[rgba(21,21,22,0.54)] p-2 text-[rgba(245,245,247,0.86)] no-underline shadow-[var(--speed-dial-card-inset,inset_0_1px_0_rgba(255,255,255,0.075))] [filter:var(--speed-dial-card-drop,drop-shadow(0_14px_32px_rgba(0,0,0,0.14)))] cursor-pointer touch-none select-none [transform:none] [transition:var(--speed-dial-card-transition,border-color_160ms_var(--ui-ease-standard),background-color_160ms_var(--ui-ease-standard),box-shadow_160ms_var(--ui-ease-standard),transform_160ms_var(--ui-ease-standard),opacity_var(--ui-motion-standard)_var(--ui-ease-standard))] [-webkit-backdrop-filter:var(--speed-dial-card-filter,blur(8px)_saturate(1.06))] [backdrop-filter:var(--speed-dial-card-filter,blur(8px)_saturate(1.06))] hover:border-[var(--speed-dial-card-hover-border,rgba(245,245,247,0.16))] hover:bg-[var(--speed-dial-card-hover-bg,rgba(31,32,35,0.62))] focus-visible:border-[var(--speed-dial-card-hover-border,rgba(245,245,247,0.16))] focus-visible:bg-[var(--speed-dial-card-hover-bg,rgba(31,32,35,0.62))] focus-visible:outline-none ${SPEED_DIAL_CARD_REDUCED_MOTION_CLASS}`
const SPEED_DIAL_CARD_DRAG_RESTING_CLASS = 'curator-motion-disabled [--speed-dial-card-active-transform:none] [--speed-dial-card-filter:blur(12px)_saturate(1.12)] [--speed-dial-card-hover-bg:rgba(21,21,22,0.54)] [--speed-dial-card-hover-border:var(--ui-divider)] opacity-100 active:border-[var(--ui-divider)] active:bg-[rgba(21,21,22,0.54)]'
