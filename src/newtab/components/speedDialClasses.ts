...
export const SPEED_DIAL_PANEL_CLASS = 'newtab-speed-dial mb-3.5 grid w-full min-w-0 gap-2.5 rounded-[var(--ui-radius-group)] border border-[var(--newtab-glass-stroke)] [border-width:var(--newtab-glass-stroke-width)] bg-[var(--newtab-glass-bg-fill)] p-2.5 shadow-none [filter:var(--newtab-glass-drop)] [-webkit-backdrop-filter:var(--newtab-glass-backdrop-filter)] [backdrop-filter:var(--newtab-glass-backdrop-filter)]'
...
export const SPEED_DIAL_META_CLASS = 'min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-xs font-[580] leading-[1.2] text-[rgba(245,245,247,0.9)] data-[tone=error]:text-[#ffb7b0]'
...
const SPEED_DIAL_CARD_DRAG_RESTING_MOTION_CLASS = '[--speed-dial-card-transition:transform_var(--drag-settle-dur)_var(--ease-smooth-out),opacity_var(--ui-motion-standard)_var(--ui-ease-standard)]'
...
export const SPEED_DIAL_COPY_DETAIL_CLASS = 'newtab-speed-dial-copy-detail min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-xs font-[560] leading-[1.25] text-[rgba(245,245,247,0.9)]'
export const SPEED_DIAL_DRAG_HANDLE_CLASS = 'speed-dial-drag-handle absolute top-1/2 right-0.5 z-[2] hidden h-10 w-10 -translate-y-1/2 touch-none items-center justify-center rounded-[var(--ui-radius-control)] text-[rgba(245,245,247,0.9)] transition-colors duration-[var(--ds-motion-feedback)] [@media(pointer:coarse)]:inline-flex active:bg-[rgba(245,245,247,0.1)] active:text-[var(--ui-text-primary)] data-[drag-pending=true]:bg-[rgba(245,245,247,0.12)] data-[drag-pending=true]:text-[var(--ui-text-primary)]'
...
export const SPEED_DIAL_EMPTY_TITLE_CLASS = 'text-[12px] leading-[1.25] text-[rgba(245,245,247,0.9)]'
export const SPEED_DIAL_EMPTY_DETAIL_CLASS = 'text-xs leading-[1.5] text-[rgba(245,245,247,0.9)]'
