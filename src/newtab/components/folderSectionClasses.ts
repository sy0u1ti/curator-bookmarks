...
export const FOLDER_SECTION_COUNT_CLASS = 'folder-section-count inline-flex shrink-0 items-center justify-center self-center text-xs font-bold leading-[1.2] tabular-nums text-[var(--ui-accent-text)]'
