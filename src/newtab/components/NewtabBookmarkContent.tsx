...
const SOURCE_NAVIGATION_COUNT_CLASS = 'source-navigation-count inline-flex shrink-0 items-center justify-center self-center text-xs font-[760] leading-[1.2] tabular-nums text-[var(--ui-accent-text)]'
