...
export const SEARCH_SLOT_CLASS = 'newtab-search-slot relative z-[2] mt-[var(--search-offset-y)] h-[var(--search-height)] w-full justify-self-center [--search-effective-width:min(max(560px,var(--search-width)),640px,100%)] [--search-height:40px] [--search-offset-y:0px] [--search-width:44vw]'
export const SEARCH_SHELL_CLASS = 'newtab-search-shell'
export const SEARCH_FORM_CLASS = 'newtab-search group relative z-[1] mx-auto flex h-[var(--search-height)] w-[var(--search-effective-width)] items-center gap-2 rounded-[var(--ui-radius-pill)] border border-[rgba(245,245,247,0.13)] bg-[rgba(8,8,9,var(--search-bg-alpha))] py-0 pr-2 pl-4 shadow-[0_12px_34px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.04)] transition-[border-color,background,box-shadow] duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-standard)] hover:border-[rgba(245,245,247,0.2)] focus-within:border-[rgba(245,245,247,0.3)] focus-within:bg-[rgba(14,14,15,calc(var(--search-bg-alpha)+0.1))] focus-within:shadow-[0_14px_38px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.05),0_0_0_3px_var(--ui-focus-ring-soft)] motion-reduce:transform-none motion-reduce:transition-none [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)] [--search-bg-alpha:0.58] [--search-height:40px] [--search-width:44vw]'
export const SEARCH_ICON_CLASS = 'newtab-search-icon pointer-events-none shrink-0 text-[var(--ui-text-tertiary)] transition-colors duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-standard)] group-focus-within:text-[var(--ui-text-secondary)] motion-reduce:transition-none'
export const SEARCH_INPUT_CLASS = 'newtab-search-input h-full min-w-0 flex-1 appearance-none rounded-none border-0 bg-transparent px-0.5 text-[15px] font-medium leading-normal text-[var(--ui-text-primary)] caret-[var(--ui-text-primary)] outline-0 placeholder:text-[var(--ui-text-tertiary)] [&::-webkit-search-cancel-button]:hidden [&::-webkit-search-cancel-button]:appearance-none [&::-webkit-search-decoration]:hidden [&::-webkit-search-decoration]:appearance-none'
...
const SEARCH_ICON_BUTTON_CLASS = 'inline-flex h-[30px] min-h-0 w-[30px] min-w-0 shrink-0 items-center justify-center rounded-[var(--ui-radius-pill)] border-0 bg-transparent p-0 text-[var(--ui-text-secondary)] transition-[background,color,transform] duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-spring)] hover:bg-[rgba(245,245,247,0.1)] hover:text-[var(--ui-text-primary)] focus-visible:bg-[rgba(245,245,247,0.1)] focus-visible:text-[var(--ui-text-primary)] focus-visible:outline-none active:scale-[0.92] disabled:cursor-default disabled:opacity-40 disabled:hover:bg-transparent disabled:hover:text-[var(--ui-text-secondary)] disabled:active:scale-100 motion-reduce:transition-none motion-reduce:active:scale-100'
...
const SEARCH_CHIP_BUTTON_BASE_CLASS = 'inline-flex h-[30px] min-h-0 w-auto max-w-none shrink-0 items-center justify-center gap-[5px] whitespace-nowrap rounded-[var(--ui-radius-pill)] border border-[var(--ui-divider)] bg-transparent px-3 text-xs font-medium leading-none tracking-[0] text-[var(--ui-text-secondary)] transition-[background,border-color,color,box-shadow] duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-standard)] hover:border-[var(--ui-divider-strong)] hover:bg-[rgba(245,245,247,0.08)] hover:text-[var(--ui-text-primary)] focus-visible:border-[var(--ui-divider-strong)] focus-visible:bg-[rgba(245,245,247,0.08)] focus-visible:text-[var(--ui-text-primary)] focus-visible:shadow-[0_0_0_3px_var(--ui-focus-ring-soft)] focus-visible:outline-none motion-reduce:transition-none'
...
export const SEARCH_ENGINE_MENU_CLASS = 'newtab-search-engine-menu grid w-44 gap-[3px] rounded-[var(--ui-radius-group)] border border-[var(--ui-divider)] bg-[rgba(15,15,15,0.56)] p-1.5 shadow-[0_18px_44px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.04)] motion-reduce:transform-none motion-reduce:transition-none [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)]'
...
export const SEARCH_ENGINE_MENU_HINT_CLASS = 'newtab-search-engine-menu-hint px-2 pt-1 pb-0.5 text-[10px] leading-[1.35] text-[rgba(245,245,247,0.42)]'

export const SEARCH_PANEL_CLASS = 'newtab-search-suggestions-panel absolute top-[calc(var(--search-height)+8px)] left-1/2 grid max-h-[min(312px,calc(100vh-180px))] w-[var(--search-effective-width)] -translate-x-1/2 gap-[3px] overflow-y-auto rounded-[var(--ui-radius-group)] border border-[var(--ui-divider)] bg-[rgba(15,15,15,0.56)] p-1.5 shadow-[0_18px_44px_rgba(0,0,0,0.34),inset_0_1px_0_rgba(255,255,255,0.04)] [scrollbar-color:rgba(245,245,247,0.22)_transparent] [scrollbar-width:thin] [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)]'
...
export function getSearchChipClass(kind: string): string {
  return cx(SEARCH_CHIP_CLASS, kind)
}
