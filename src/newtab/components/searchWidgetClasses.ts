...
export const SEARCH_FORM_CLASS = 'newtab-search group relative z-[1] mx-auto flex h-[var(--search-height)] w-[var(--search-effective-width)] items-center gap-2 rounded-[var(--ui-radius-group)] border border-[rgba(245,245,247,0.13)] bg-[rgba(8,8,9,var(--search-bg-alpha))] py-0 pr-2 pl-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [filter:drop-shadow(0_12px_34px_rgba(0,0,0,0.18))] transition-[border-color,background,box-shadow,filter] duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-standard)] hover:border-[rgba(245,245,247,0.2)] focus-within:border-[rgba(245,245,247,0.3)] focus-within:bg-[rgba(14,14,15,calc(var(--search-bg-alpha)+0.1))] focus-within:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] focus-within:[filter:drop-shadow(0_14px_38px_rgba(0,0,0,0.2))] focus-within:[outline:3px_solid_var(--ui-focus-ring-soft)] focus-within:outline-offset-0 motion-reduce:transform-none motion-reduce:transition-none [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)] [--search-bg-alpha:0.58] [--search-height:40px] [--search-width:44vw]'
...
export const SEARCH_ENGINE_MENU_CLASS = 'newtab-search-engine-menu grid w-44 gap-[3px] rounded-[var(--ui-radius-group)] border border-[var(--ui-divider)] bg-[rgba(15,15,15,0.56)] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [filter:drop-shadow(0_18px_44px_rgba(0,0,0,0.34))] motion-reduce:transform-none motion-reduce:transition-none [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)]'
...
export const SEARCH_PANEL_CLASS = 'newtab-search-suggestions-panel absolute top-[calc(var(--search-height)+8px)] left-1/2 max-[520px]:left-0 grid max-h-[min(312px,calc(100vh-180px))] w-[var(--search-effective-width)] -translate-x-1/2 max-[520px]:translate-x-0 gap-[3px] overflow-y-auto rounded-[var(--ui-radius-group)] border border-[var(--ui-divider)] bg-[rgba(15,15,15,0.56)] p-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [filter:drop-shadow(0_18px_44px_rgba(0,0,0,0.34))] [scrollbar-color:rgba(245,245,247,0.22)_transparent] [scrollbar-width:thin] [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)]'
