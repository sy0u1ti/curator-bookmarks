...
export const SEARCH_FORM_CLASS = 'newtab-search group relative z-[1] mx-auto flex h-[var(--search-height)] w-[var(--search-effective-width)] items-center gap-2 rounded-[var(--ui-radius-group)] border border-[rgba(245,245,247,0.13)] bg-[rgba(8,8,9,var(--search-bg-alpha))] py-0 pr-2 pl-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] [filter:drop-shadow(0_12px_34px_rgba(0,0,0,0.18))] transition-[border-color,background-color,box-shadow] duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-standard)] hover:border-[rgba(245,245,247,0.2)] focus-within:border-[rgba(245,245,247,0.3)] focus-within:bg-[rgba(14,14,15,calc(var(--search-bg-alpha)+0.1))] focus-within:shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] focus-within:[outline:3px_solid_var(--ui-focus-ring-soft)] focus-within:outline-offset-0 motion-reduce:transition-colors motion-reduce:duration-[80ms] [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)] [--search-bg-alpha:0.58] [--search-height:40px] [--search-width:44vw]'
