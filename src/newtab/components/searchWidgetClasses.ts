...
export const SEARCH_FORM_CLASS = 'newtab-search group relative z-[1] flex h-[var(--search-height)] w-full items-center gap-2 rounded-[var(--ui-radius-group)] border border-[rgba(245,245,247,0.14)] bg-[rgba(8,8,9,var(--search-bg-alpha))] py-0 pr-2 pl-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] [filter:drop-shadow(0_14px_36px_rgba(0,0,0,0.22))] transition-[border-color,background-color,box-shadow] duration-[var(--ui-motion-fast)] ease-[var(--ui-ease-standard)] hover:border-[rgba(245,245,247,0.22)] focus-within:border-[rgba(245,245,247,0.32)] focus-within:bg-[rgba(10,11,13,calc(var(--search-bg-alpha)+0.08))] focus-within:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] focus-within:[outline:3px_solid_var(--ui-focus-ring-soft)] focus-within:outline-offset-0 motion-reduce:transition-colors motion-reduce:duration-[80ms] [-webkit-backdrop-filter:var(--newtab-glass-filter-hero)] [backdrop-filter:var(--newtab-glass-filter-hero)] [--search-bg-alpha:0.56] [--search-height:40px] [--search-width:44vw]'
...
const SEARCH_SUGGESTION_ACTIVE_CLASS = '[&.active]:bg-[var(--ui-surface-selected)] [&.active]:text-[var(--ui-text-primary)] [&.active]:shadow-[inset_0_0_0_1px_rgba(245,245,247,0.16)] [&.active:hover]:bg-[rgba(245,245,247,0.19)] [&.active:focus-visible]:bg-[var(--ui-surface-selected)] [&_.newtab-search-suggestion-mark]:border-[rgba(245,245,247,0.24)] [&_.newtab-search-suggestion-mark]:bg-[rgba(245,245,247,0.14)] [&_.newtab-search-suggestion-mark]:text-[rgba(245,245,247,0.96)] [&_.newtab-search-suggestion-meta]:text-[rgba(245,245,247,0.86)]'
