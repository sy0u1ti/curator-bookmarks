...
const BOOKMARK_TITLE_CLASS = 'bookmark-title w-full overflow-hidden text-[13px] font-[520] leading-[1.3] text-[rgba(245,245,247,0.9)] [display:-webkit-box] [overflow-wrap:anywhere] [-webkit-box-orient:vertical] [-webkit-line-clamp:var(--icon-title-lines)]'
...
export const BOOKMARK_FOLDER_CARD_ICON_CLASS = 'bookmark-folder-card-icon relative grid h-[var(--icon-shell-size)] w-[var(--icon-shell-size)] place-items-center rounded-[var(--ui-radius-control)] border border-[rgba(245,245,247,0.14)] bg-[rgba(0,0,0,0.28)] text-[rgba(245,245,247,0.9)] shadow-[inset_0_1px_0_rgba(255,255,255,0.045)]'
export const BOOKMARK_FOLDER_CARD_COUNT_CLASS = 'bookmark-folder-card-count ml-auto inline-grid h-[17px] min-w-5 place-items-center rounded-[var(--ui-radius-pill)] bg-[var(--ui-surface-selected)] px-1 text-xs font-bold leading-none text-[var(--ui-accent-text)]'
