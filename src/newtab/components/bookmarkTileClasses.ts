...
const BOOKMARK_TILE_BASE_CLASS = `bookmark-tile group/bookmark-tile relative [--bookmark-card-rgb:245_245_247] [--bookmark-card-bg-alpha:0.44] [--bookmark-card-border-alpha:0] [--bookmark-card-hover-alpha:0.4] grid w-full items-center justify-self-stretch rounded-[var(--ui-radius-control)] border border-transparent bg-[rgba(21,21,22,0.64)] text-left leading-normal text-[var(--ui-text-primary)] no-underline shadow-[0_1px_2px_rgba(0,0,0,0.16),inset_0_1px_0_rgba(255,255,255,0.075)] outline-none cursor-pointer touch-pan-y select-none [transform:none] [transition:var(--bookmark-tile-transition,border-color_130ms_var(--ui-ease-standard),background-color_130ms_var(--ui-ease-standard),box-shadow_130ms_var(--ui-ease-standard),transform_130ms_var(--ui-ease-standard),opacity_var(--ui-motion-standard)_var(--ui-ease-standard))] focus-visible:outline-none active:bg-[var(--bookmark-tile-active-bg,rgba(36,37,41,0.72))] active:shadow-[0_1px_2px_rgba(0,0,0,0.16),inset_0_1px_0_rgba(255,255,255,0.075)] active:duration-[60ms] ${BOOKMARK_TILE_REDUCED_MOTION_CLASS}`
