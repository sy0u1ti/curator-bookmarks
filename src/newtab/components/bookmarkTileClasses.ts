...
const BOOKMARK_TILE_BASE_CLASS = `curator-motion-card bookmark-tile group/bookmark-tile [--bookmark-card-rgb:245_245_247] [--bookmark-card-bg-alpha:0.3] [--bookmark-card-border-alpha:0] [--bookmark-card-hover-alpha:0.4] grid w-full items-center justify-self-stretch rounded-[var(--ui-radius-control)] border border-transparent bg-[rgba(21,21,22,0.54)] text-left leading-normal text-[var(--ui-text-primary)] no-underline shadow-[0_14px_32px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.075)] outline-none cursor-pointer touch-none select-none [transform:none] [transition:var(--bookmark-tile-transition,border-color_160ms_var(--ui-ease-standard),background-color_160ms_var(--ui-ease-standard),box-shadow_160ms_var(--ui-ease-standard),transform_160ms_var(--ui-ease-standard),opacity_var(--ui-motion-standard)_var(--ui-ease-standard))] [-webkit-backdrop-filter:blur(12px)_saturate(1.12)] [backdrop-filter:blur(12px)_saturate(1.12)] hover:border-transparent hover:bg-[var(--bookmark-tile-hover-bg,rgba(31,32,35,0.62))] hover:shadow-[var(--bookmark-tile-hover-shadow,0_14px_32px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.075))] hover:[-webkit-backdrop-filter:blur(12px)_saturate(1.12)] hover:[backdrop-filter:blur(12px)_saturate(1.12)] focus-visible:border-transparent focus-visible:bg-[var(--bookmark-tile-hover-bg,rgba(31,32,35,0.62))] focus-visible:shadow-[var(--bookmark-tile-hover-shadow,0_14px_32px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.075))] focus-visible:outline-none focus-visible:[-webkit-backdrop-filter:blur(12px)_saturate(1.12)] focus-visible:[backdrop-filter:blur(12px)_saturate(1.12)] active:bg-[var(--bookmark-tile-active-bg,rgba(36,37,41,0.66))] active:shadow-[0_14px_32px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.075)] active:duration-[60ms] active:[-webkit-backdrop-filter:blur(12px)_saturate(1.12)] active:[backdrop-filter:blur(12px)_saturate(1.12)] ${BOOKMARK_TILE_REDUCED_MOTION_CLASS}`
...
const BOOKMARK_TILE_DRAG_RESTING_CLASS = 'curator-motion-disabled [--bookmark-icon-active-bg:rgba(0,0,0,0.34)] [--bookmark-icon-active-border:rgb(var(--bookmark-card-rgb)/0.12)] [--bookmark-icon-transition:none] [--bookmark-tile-active-bg:rgba(21,21,22,0.54)] [--bookmark-tile-active-transform:none] [--bookmark-tile-hover-bg:rgba(21,21,22,0.54)] [--bookmark-tile-hover-shadow:0_14px_32px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.075)] opacity-100'
