...
const BOOKMARK_TILE_DRAG_RESTING_CLASS = '[--bookmark-icon-active-bg:rgba(0,0,0,0.34)] [--bookmark-icon-active-border:rgb(var(--bookmark-card-rgb)/0.12)] [--bookmark-icon-transition:none] [--bookmark-tile-active-bg:rgba(21,21,22,0.54)] [--bookmark-tile-active-transform:none] [--bookmark-tile-hover-bg:rgba(21,21,22,0.54)] [--bookmark-tile-hover-shadow:0_14px_32px_rgba(0,0,0,0.14),inset_0_1px_0_rgba(255,255,255,0.075)] opacity-100'
