...
const MODEL_SELECTOR_BACKDROP_CLASS =
  'fixed inset-0 z-[1200] min-h-dvh bg-ds-overlay transition-opacity duration-ds-fast ease-ds-standard data-ending-style:opacity-0 data-starting-style:opacity-0 supports-[-webkit-touch-callout:none]:absolute'
const MODEL_SELECTOR_CONTENT_CLASS =
  'fixed left-1/2 top-[46%] z-[1201] max-h-[min(520px,calc(100dvh-72px))] w-[min(520px,calc(100vw-36px))] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-ds-lg border border-ds-border bg-ds-surface-2 p-0 text-ds-text-primary shadow-ds-dialog outline-none transition-[opacity,transform] duration-ds-fast ease-ds-standard data-ending-style:translate-y-[calc(-50%+8px)] data-ending-style:scale-[0.98] data-ending-style:opacity-0 data-starting-style:translate-y-[calc(-50%+8px)] data-starting-style:scale-[0.98] data-starting-style:opacity-0 max-[760px]:top-1/2 max-[760px]:w-[min(520px,calc(100vw-24px))]'
