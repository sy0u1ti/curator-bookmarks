  ...
  return (
    <BaseSwitch.Root
      ...
      className={unstyled ? className : cx(
        'relative inline-block h-5 w-9 rounded-full border border-curator-border bg-curator-muted outline-none transition-colors data-[checked]:border-curator-text data-[checked]:bg-curator-text focus-visible:ring-2 focus-visible:ring-white/25 data-[disabled]:opacity-50',
        className
      )}
      disabled={disabled}
    ...
    >
      <BaseSwitch.Thumb
        className={unstyled ? thumbClassName : cx(
          'absolute left-0.5 top-0.5 size-4 rounded-full bg-curator-text-subtle transition-transform data-[checked]:translate-x-4 data-[checked]:bg-curator-bg',
          thumbClassName
        )}
      />
    </BaseSwitch.Root>
