  ...
  return (
    <BaseCheckbox.Root
      ...
      className={unstyled ? className : cx(
        'flex size-4 items-center justify-center rounded border border-curator-border bg-curator-bg-panel text-curator-text outline-none transition-colors data-[checked]:border-curator-text data-[checked]:bg-curator-text data-[checked]:text-curator-bg focus-visible:ring-2 focus-visible:ring-white/25',
        className
      )}
      disabled={disabled}
