          ...
          >
            {actions.map((action) => (
              <BaseMenu.Item
                ...
                className="flex cursor-default items-center justify-between gap-3 rounded-ds-sm px-2.5 py-2 outline-none data-[highlighted]:bg-ds-hover data-[disabled]:opacity-45"
              >
