...
export function cacheDom(): void {
  ...
  dom.searchHelpPanel = byId('search-help-panel')
  dom.searchChips = byId('search-chips')
  dom.savedSearchSelect = byId('saved-search-select')
  dom.saveSearch = byId('save-search')
  dom.deleteSavedSearch = byId('delete-saved-search')
