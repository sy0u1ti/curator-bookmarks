...
const TOAST_BUTTON_CLASS = [
  ...
  'transition-[background-color,border-color,color,transform] duration-ds-fast ease-ds-standard',
...
const TOAST_ROOT_CLASS = [
  't-toast pointer-events-auto relative flex min-w-60 max-w-80 items-center gap-3',
