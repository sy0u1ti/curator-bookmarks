...
export const AI_SETTINGS_HELP_TOOLTIP_POPUP_CLASS =
  'z-[80] w-[min(300px,calc(100vw-48px))] rounded-ds-sm border border-ds-hover bg-ds-app p-[10px_12px] text-left text-xs font-medium leading-[1.6] text-ds-text-primary shadow-ds-popover transition-[opacity,transform] duration-ds-standard ease-ds-standard data-starting-style:translate-y-1 data-starting-style:opacity-0 data-ending-style:translate-y-1 data-ending-style:opacity-0 motion-reduce:transition-none'
